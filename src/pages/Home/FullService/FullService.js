...
const FullService = ({service, handleDeleteService}) => {
    ...
    return (
        <div className="">
            ...
            <button onClick={() => handleDeleteService(service?._id)} className="bg-red-400 px-3 py-1 rounded-2xl text-white mb-2">Delete</button>
        </div>
        </div>
        </div>
        </div>
