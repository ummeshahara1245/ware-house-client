      ...
      <div className="bg-gray-100">
        ...
        <div className="lg:h-screen">
          <li className="list-none bg-green-500 px-8 py-2 border border-green-500 text-white">
            <Link className="text-white no-underline font-semibold" to="/manageBookings"><i class="fas fa-align-justify"></i> Manage Items</Link><br />
          </li>
          <li className="list-none bg-green-500 px-8 py-2 border border-green-500 text-white">
            <Link className="text-white no-underline font-semibold" to="/addService"><i class="fas fa-plus-square"></i> Add Service</Link><br />
          </li>
          <li className="list-none bg-green-500 px-8 py-2 border border-green-500 text-white">
            <Link className="text-white no-underline font-semibold" to="/dashboard"><i class="fas fa-border-all"></i> Manage Inventories</Link><br />
          </li>
